...
export const LENDER_PRODUCT_CATEGORY_LABELS = {
    TERM_LOAN: "Term loan",
...
export const isLenderProductCategory = (value) => LENDER_PRODUCT_CATEGORIES.includes(value);
...
export const RATE_TYPES = ["fixed", "variable", "factor"];
export const TERM_UNITS = ["months", "years"];
export const SUBMISSION_METHODS = ["GOOGLE_SHEET", "EMAIL", "API", "MANUAL"];
