...
const menu: CSSProperties = { position: "absolute", top: "100%", right: 0, marginTop: 4, background: "#fff", border: "1px solid #cbd6e2", borderRadius: 8, padding: 8, zIndex: 50, minWidth: 190, boxShadow: "0 4px 12px rgba(0,0,0,0.12)" };
