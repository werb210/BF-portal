...
import { ContactApplicantFields, ContactAdvisors, ContactPartners } from "@/components/crm/ContactApplicationDetails"; // BF_PORTAL_CRM_CONTACT_PANELS_v1
  ...
  return (
    <>
      ...
      <aside style={rail}>
        <Link
          to="/crm/contacts"
          style={{ color: "var(--ui-accent-fg)", fontSize: 14, display: "inline-flex", alignItems: "center", gap: 4, marginBottom: 12 }}
