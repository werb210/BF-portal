  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-sm rounded border bg-white p-4 space-y-3">
        <h1 className="text-xl font-semibold">Sign In to Lender Portal</h1>
        ...
        <button className="ui-button ui-button--primary w-full" onClick={() => navigate("/lender-portal/deals")}>Continue</button>
      </div>
    </div>
  );
};
