...
export type BiApplicationDetailData = { id: string; stage: BiStageId; source_type: "public" | "lender"; guarantor_name: string; guarantor_email: string; business_name: string; lender_name: string | null; data: Record<string, unknown>; insurer_response?: Record<string, unknown>; docs_review_required: boolean; all_docs_accepted: boolean; submission_locked: boolean; is_demo?: boolean | null; application_code?: string | null; loan_amount?: number | null; pgi_limit?: number | null; carrier_received_at?: string | null; carrier_last_event?: string | null; carrier_last_event_at?: string | null; pgi_application_id?: string | null; carrier_submission_request?: Record<string, unknown> | null; carrier_submission_response?: Record<string, unknown> | null; carrier_submission_error?: string | null; }; // BF_PORTAL_BLOCK_v193_BI_SILO_ALIGN_v2
