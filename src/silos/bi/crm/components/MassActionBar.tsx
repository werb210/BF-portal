...
const bar: CSSProperties = { position: "sticky", top: 0, zIndex: 2, width: "100%", background: "#f1f5f9", padding: 12, marginBottom: 12, display: "flex", justifyContent: "space-between", alignItems: "center", borderRadius: 8 };
