...
const ChatWindow = () => {
  ...
  const handleSend = async () => {
    if (!selectedSession || !draft.trim() || isClosed || isSubmittingMessage) return;
  ...
  const handleCloseSession = async () => {
    if (!selectedSession || isClosed || isClosingSession) return;
        ...
        {selectedSession ? (
          <>
            <header className="flex items-center justify-between border-b border-slate-200 p-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  disabled={isClosed || isClosingSession}
            ...
            <div ref={streamRef} className="flex-1 space-y-3 overflow-y-auto p-4">
              {isLoadingMessages && <p className="text-xs text-slate-500">Loading messages…</p>}
              {messageError && <p className="text-xs text-amber-600">{messageError}</p>}
            ...
            <footer className="border-t border-slate-200 p-4">
              <div className="flex gap-2">
                <input
                  ...
                  disabled={isClosed || isSubmittingMessage}
                ...
                <button
                  ...
                  disabled={isClosed || !draft.trim() || isSubmittingMessage}
